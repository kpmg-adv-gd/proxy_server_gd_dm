...
const { manageReceiveConfirmationNumber } = require("./library");

module.exports.listenerSetup = (app) => {

    app.post("/iFlow/MANAGE_RECEIVE_CONFIRMATION_NUMBER", authMiddlewareCPI, async (req, res) => {

        try {
            console.log("MANAGE_RECEIVE_CONFIRMATION_NUMBER= "+JSON.stringify(req.body))
            let json = req.body;
            var result = await manageReceiveConfirmationNumber(json);
