...
const getIfModificaMAIsAppliedQuery = `SELECT *
                                        FROM z_modify
                                        WHERE plant=$1 AND wbe=$2 AND process_id=$3 AND resolution IS NULL;`
...
module.exports = { insertZModificheQuery, getModificheDataQuery, getModificheDataGroupMAQuery, getIfModificaMAIsAppliedQuery, updateStatusModificaQuery, updateResolutionModificaMAQuery, getOperationModificheBySfcQuery, getModificheToDoQuery, updateZModifyByOrderQuery };