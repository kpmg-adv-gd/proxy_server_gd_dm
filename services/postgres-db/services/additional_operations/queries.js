...
const getAdditionalOperationsToVerbaleQuery = `SELECT DISTINCT z.section, z.material, z."order", z.group_code, z.group_description, z.operation, z.operation_description FROM z_additional_operations z where plant = $1 and project = $2 and section = $3`;
...
const getMarkingDataForAddOptQuery = `SELECT * FROM z_marking_recap WHERE plant = $1 AND wbe_machine = $2 AND mes_order = $3 AND confirmation_number = $4`;

module.exports = { getAdditionalOperationsQuery, getInfoAdditionalOperation, startAdditionalOperation, completeAdditionalOperation, checkDefectCompleteOperation, getAdditionalOperationsToVerbaleQuery, insertZAddtionalOperationsQuery, getMarkingDataForAddOptQuery };