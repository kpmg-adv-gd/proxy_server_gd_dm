...
const getAdditionalOperationsToVerbaleQuery = `SELECT DISTINCT z.section, z.material, z."order", z.group_code, z.group_description, z.operation, z.operation_description, z.duration FROM z_additional_operations z where plant = $1 and project = $2 and section = $3`;
...
(plant, project, "section", sfc, "order", material, group_code, group_description, operation, operation_description, phase, status, step_id, mes_order, workcenter, duration)
VALUES(
$1, -- plant
$2, -- project
$3, -- section
