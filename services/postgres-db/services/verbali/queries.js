...
const getCommentsVerbale = `SELECT sfc, plant, id_lev_2, id_lev_3, machine_type, "user", comment, comment_type, status, approval_user, 
    ...
    TO_CHAR((approval_datetime::timestamp  AT TIME ZONE 'UTC') AT TIME ZONE 'Europe/Rome', 'DD/MM/YYYY HH24:MI:SS') as approval_datetime
    FROM z_comments
    WHERE plant = $1 AND sfc = $2 AND id_lev_1 = $3
    AND id_lev_2 = $4
    AND id_lev_3 = $5
...
const duplicateVerbaleLev2ByStepId = `INSERT INTO z_verbale_lev_2 ("order", id_lev_1, lev_2, id_lev_2, machine_type, safety, time_lev_2, uom, workcenter_lev_2, status_lev_2, plant, active, blocked, priority, wbe, sfc, date_lev_1, lev_1)
    SELECT "order", $3, lev_2, id_lev_2, machine_type, $4, time_lev_2, uom, $5, status_lev_2, plant, $6, blocked, priority, wbe, sfc, date_lev_1, $9
    FROM z_verbale_lev_2 
